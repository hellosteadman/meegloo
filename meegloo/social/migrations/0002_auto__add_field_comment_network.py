...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.network'
        db.add_column('social_comment', 'network', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='comments', to=orm['networks.Network']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.network'
        db.delete_column('social_comment', 'network_id')
