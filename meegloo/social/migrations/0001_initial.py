...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_comment', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['contenttypes.ContentType'])),
            ...
            ('tweet', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
