...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Set.source_name'
        db.delete_column('streams_set', 'source_name')

        # Deleting field 'Set.source_url'
        db.delete_column('streams_set', 'source_url')

        # Adding field 'Set.application'
        db.add_column('streams_set', 'application', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sets', null=True, to=orm['piston.Consumer']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Set.source_name'
        db.add_column('streams_set', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Set.source_url'
        db.add_column('streams_set', 'source_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Set.application'
        db.delete_column('streams_set', 'application_id')
