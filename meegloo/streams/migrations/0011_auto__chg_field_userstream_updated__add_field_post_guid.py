...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Changing field 'UserStream.updated'
		db.alter_column('streams_stream_user', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

		# Adding field 'Post.guid'
		db.add_column('streams_post', 'guid', self.gf('django.db.models.fields.CharField')(default='uuid4', max_length=36), keep_default=False)
		
		if not db.dry_run:
			for post in orm.Post.objects.filter(guid = 'uuid4'):
				post.guid = str(uuid4())
				post.save()
		
		db.create_unique('streams_post', 'guid')


	def backwards(self, orm):
		
		# Changing field 'UserStream.updated'
		db.alter_column('streams_stream_user', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

		# Deleting field 'Post.guid'
		db.delete_column('streams_post', 'guid')
