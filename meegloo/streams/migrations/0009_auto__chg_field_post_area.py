...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.area'
        db.alter_column('streams_post', 'area', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'Post.area'
        db.alter_column('streams_post', 'area', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
