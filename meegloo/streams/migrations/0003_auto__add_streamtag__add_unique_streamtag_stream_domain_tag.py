...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StreamTag'
        db.create_table('streams_stream_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stream', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['streams.Stream'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stream_tags', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('streams', ['StreamTag'])

        # Adding unique constraint on 'StreamTag', fields ['stream', 'domain', 'tag']
        db.create_unique('streams_stream_tag', ['stream_id', 'domain', 'tag'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StreamTag', fields ['stream', 'domain', 'tag']
        db.delete_unique('streams_stream_tag', ['stream_id', 'domain', 'tag'])

        # Deleting model 'StreamTag'
        db.delete_table('streams_stream_tag')
