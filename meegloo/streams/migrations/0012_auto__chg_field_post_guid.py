...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('streams_post', 'guid', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Post.guid'
        db.alter_column('streams_post', 'guid', self.gf('django.db.models.fields.CharField')(default='', max_length=36, unique=True))
