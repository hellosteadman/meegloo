...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Trend'
        db.create_table('streams_trend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stream', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trends', to=orm['streams.Stream'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('posts', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('streams', ['Trend'])


    def backwards(self, orm):
        
        # Deleting model 'Trend'
        db.delete_table('streams_trend')
