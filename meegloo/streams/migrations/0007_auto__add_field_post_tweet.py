...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.tweet'
        db.add_column('streams_post', 'tweet', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.tweet'
        db.delete_column('streams_post', 'tweet')
