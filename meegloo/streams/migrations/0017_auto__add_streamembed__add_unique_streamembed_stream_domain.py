...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StreamEmbed'
        db.create_table('streams_stream_embed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stream', self.gf('django.db.models.fields.related.ForeignKey')(related_name='embeds', to=orm['streams.UserStream'])),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('streams', ['StreamEmbed'])

        # Adding unique constraint on 'StreamEmbed', fields ['stream', 'domain']
        db.create_unique('streams_stream_embed', ['stream_id', 'domain'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StreamEmbed', fields ['stream', 'domain']
        db.delete_unique('streams_stream_embed', ['stream_id', 'domain'])

        # Deleting model 'StreamEmbed'
        db.delete_table('streams_stream_embed')
