...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stream.network'
        db.add_column('streams_stream', 'network', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='streams', to=orm['networks.Network']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stream.network'
        db.delete_column('streams_stream', 'network_id')
