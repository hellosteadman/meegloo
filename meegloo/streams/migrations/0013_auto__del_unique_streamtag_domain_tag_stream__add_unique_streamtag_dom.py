...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'StreamTag', fields ['domain', 'tag', 'stream']
        try:
            db.delete_unique('streams_stream_tag', ['domain', 'tag', 'stream_id'])
        except:
            pass

        # Adding unique constraint on 'StreamTag', fields ['domain', 'tag', 'user', 'stream']
        db.create_unique('streams_stream_tag', ['domain', 'tag', 'user_id', 'stream_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StreamTag', fields ['domain', 'tag', 'user', 'stream']
        db.delete_unique('streams_stream_tag', ['domain', 'tag', 'user_id', 'stream_id'])

        # Adding unique constraint on 'StreamTag', fields ['domain', 'tag', 'stream']
        db.create_unique('streams_stream_tag', ['domain', 'tag', 'stream_id'])
