...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Set.kind'
        db.alter_column('streams_set', 'kind', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Post.kind'
        db.alter_column('streams_post', 'kind', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'Set.kind'
        db.alter_column('streams_set', 'kind', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Post.kind'
        db.alter_column('streams_post', 'kind', self.gf('django.db.models.fields.CharField')(max_length=5))
