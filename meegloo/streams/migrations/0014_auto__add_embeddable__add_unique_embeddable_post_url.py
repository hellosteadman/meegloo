...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('streams_embeddable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='embeddables', to=orm['streams.Post'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('streams', ['Embeddable'])

        # Adding unique constraint on 'Embeddable', fields ['post', 'url']
        db.create_unique('streams_embeddable', ['post_id', 'url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Embeddable', fields ['post', 'url']
        db.delete_unique('streams_embeddable', ['post_id', 'url'])

        # Deleting model 'Embeddable'
        db.delete_table('streams_embeddable')
