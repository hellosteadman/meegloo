...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserStream.updated'
        db.add_column('streams_stream_user', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 9, 23, 12, 19, 37, 816699), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserStream.updated'
        db.delete_column('streams_stream_user', 'updated')
