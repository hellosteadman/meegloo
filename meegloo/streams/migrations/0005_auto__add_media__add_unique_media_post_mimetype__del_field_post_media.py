...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Media'
        db.create_table('streams_media', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media', to=orm['streams.Post'])),
        ...
        db.send_create_signal('streams', ['Media'])

        # Adding unique constraint on 'Media', fields ['post', 'mimetype']
        db.create_unique('streams_media', ['post_id', 'mimetype'])

        # Deleting field 'Post.media'
        db.delete_column('streams_post', 'media')


    def backwards(self, orm):
        
        # Removing unique constraint on 'Media', fields ['post', 'mimetype']
        db.delete_unique('streams_media', ['post_id', 'mimetype'])

        # Deleting model 'Media'
        db.delete_table('streams_media')

        # Adding field 'Post.media'
        db.add_column('streams_post', 'media', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
