...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registration_passwordreset', (
            ...
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(related_name='password_resets', to=orm['networks.Network'])),
        ))
        db.send_create_signal('registration', ['PasswordReset'])


    def backwards(self, orm):
        
        # Deleting model 'PasswordReset'
        db.delete_table('registration_passwordreset')
    ...
    models = {
        ...
        'registration.emailconfirmation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'email_confirmations'", 'to': "orm['networks.Network']"}),
        ...
        'registration.passwordreset': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'password_resets'", 'to': "orm['networks.Network']"}),
            'sent': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
