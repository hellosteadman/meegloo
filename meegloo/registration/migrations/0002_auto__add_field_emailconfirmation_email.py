...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailConfirmation.email'
        db.add_column('registration_emailconfirmation', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmailConfirmation.email'
        db.delete_column('registration_emailconfirmation', 'email')
